  Ext.define('CustomApp', {
      ...
      _onBuildDefinitionLoad: function() {
          ...
          Rally.environment.getMessageBus().subscribe('buildDefinitionSelected', function(selected_buildDef) {
                                      console.log("BuildDefn from build action board: ", selected_buildDef);
                                      this.down('#buildDefinitionSelector').setValue(selected_buildDef);
                                      this._loadBuildStore();
                                  }, this);   
